...
export default function Home() {
  ...
  const [currentView, setCurrentView] = useState<'upload' | 'config' | 'history' | 'analytics' | 'integrations' | 'customrules'>('upload')
        ...
        <div className="container mx-auto px-6 py-8">
          ...
          <header className="mb-8">
            <h1 className="text-3xl font-bold text-blueprism-darkblue mb-2">
              ...
              {currentView === 'customrules' && 'Custom Rules'}
            ...
            <p className="text-gray-600">
              ...
              {currentView === 'customrules' && 'Create and manage your own validation rules'}
              {currentView === 'integrations' && 'Connect to GitHub, Jira, and other tools'}
            </p>
          </header>
