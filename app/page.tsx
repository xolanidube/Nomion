...
const pricingTiers = [
  {
    ...
    price: '$0',
    period: 'free forever',
    description: 'Perfect for evaluating Nomion on a single platform.',
    highlighted: false,
    features: [
  ...
  },
  {
    ...
    price: '$149',
    period: '/month',
    description: 'For small teams validating across multiple platforms.',
    highlighted: false,
    features: [
  ...
  },
  {
    ...
    price: '$500',
    period: '/month',
    description: 'For teams shipping automations across platforms.',
    highlighted: true,
    features: [
  ...
  },
  {
    ...
    price: 'Custom',
    period: '',
    description: 'For organizations needing full control and support.',
    highlighted: false,
    features: [
...
const faqItems = [
  ...
  },
  {
    ...
    answer: 'Yes. The Team plan includes a 14-day free trial with no credit card required. The Starter plan is free forever with 50 validations per month.',
  },
  {
